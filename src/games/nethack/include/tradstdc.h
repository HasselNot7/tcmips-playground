...
#if defined(TCMIPS_PORT) && !defined(GCC_URWARN)
/* keep __warn_unused_result__ intact: picolibc's sys/cdefs.h uses
   __has_attribute(__warn_unused_result__) and an empty macro breaks it */
#else
