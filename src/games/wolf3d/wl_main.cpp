...
{
    // No persistent config on TCMIPS: use engine defaults.
    SoundMode = sdm_Off;
    MusicMode = smm_Off;
    DigiMode  = sds_Off;
    mouseenabled = false;
    joystickenabled = false;
    viewsize = 19;          // overridden below by the boot menu selection
    mouseadjustment = 5;
    {
        extern int tcm_wolf_viewsize;
        viewsize = tcm_wolf_viewsize;
    }
}
