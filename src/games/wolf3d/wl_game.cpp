...
restartgame:
    ...
    // The pre-level sequence (GET PSYCHED fade in/out) leaves the palette
    // black; nothing else restores it before the first rendered frame on
    // ports with a software color LUT. Restore it unconditionally.
